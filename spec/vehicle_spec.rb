...
RSpec.describe Vehicle do
  ...
  describe '#electric_vehicle?' do
    ...
    describe '#get_plate' do
      it 'only returns a plate for :regular, :ev, or :antique' do
        expect(@camaro.get_plate(:antique)).to eq(:antique)
        expect(@camaro.get_plate(:avenger)).to eq(false)
      end
    end
  end
end
